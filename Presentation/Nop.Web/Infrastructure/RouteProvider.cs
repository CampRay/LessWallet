...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //add coupon to user (with attributes and options). used on the product details pages.
            routes.MapLocalizedRoute("AddCouponToUser-Details",
                            "addcoupontouser/details/{productId}",
                            new { controller = "ShoppingCart", action = "AddCouponToUser_Details" },
                            new { productId = @"\d+"},
                            new[] { "Nop.Web.Controllers" });
