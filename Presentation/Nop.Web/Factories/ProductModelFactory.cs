    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
        ...
        protected virtual PictureModel PrepareProductOverviewPictureModel(Product product, int? productThumbPictureSize = null)
        {
            ...
            PictureModel defaultPictureModel = _cacheManager.Get(cacheKey, () =>
            {
                ...
                var picture = _pictureService.GetPicturesByProductId(product.Id, _workContext.WorkingLanguage.Id, 1).FirstOrDefault();
        ...
        protected virtual dynamic PrepareProductDetailsPictureModel(Product product, bool isAssociatedProduct = false)
        {
            ...
            var cachedPictures = _cacheManager.Get(productPicturesCacheKey, () =>
            {
                ...
                var pictures = _pictureService.GetPicturesByProductId(product.Id, _workContext.WorkingLanguage.Id);
                ...
                var qrCodepictures = _pictureService.GetPictureById(product.DownloadId);
                var qrCodePictureModel = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(qrCodepictures, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(qrCodepictures, 0, !isAssociatedProduct)
                };
                return new { DefaultPictureModel = defaultPictureModel, PictureModels = pictureModels, QRCodePictureModel=qrCodePictureModel };
            });
            ...
            bool forceRedirectionAfterAddingToCart = false)
        {
            ...
            foreach (var product in products)
            {
                var model = new ProductOverviewModel
                {
                    ...
                    StartDateTime=product.AvailableStartDateTimeUtc.HasValue ? _dateTimeHelper.ConvertToUserTime(product.AvailableStartDateTimeUtc.Value, DateTimeKind.Utc).ToString("d") : _dateTimeHelper.ConvertToUserTime(product.CreatedOnUtc, DateTimeKind.Utc).ToString("d"),
                    EndDateTime= product.AvailableEndDateTimeUtc.HasValue ? _dateTimeHelper.ConvertToUserTime(product.AvailableEndDateTimeUtc.Value, DateTimeKind.Utc).ToString("d") : ""
                };
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
           ...
           //pictures
            ...
            model.QRCodePictureModel = pictureModels.QRCodePictureModel;
