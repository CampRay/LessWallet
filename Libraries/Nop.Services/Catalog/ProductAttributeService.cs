...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        /// <summary>
        /// Delete ProductAttributeCombination
        /// </summary>
        /// <param name="combinations">Product attribute combinations</param>
        public virtual void DeleteProductAttributeCombinations(IList<ProductAttributeCombination> combinations)
        {
            if (combinations == null)
                throw new ArgumentNullException("combinations");
        ...
        /// <summary>
        /// Gets product attribute combinations by identifiers
        /// </summary>
        /// <param name="productAttributeCombinationIds">Product attribute combination identifiers</param>
        /// <returns>Product attribute combination</returns>
        public virtual IList<ProductAttributeCombination> GetProductAttributeCombinationByIds(int[] productAttributeCombinationIds)
        {
            if (productAttributeCombinationIds == null || productAttributeCombinationIds.Length == 0)
                return null;

            var query = from c in _productAttributeCombinationRepository.Table                        
                        where productAttributeCombinationIds.Contains(c.Id)
                        select c;            
            return query.ToList();
