...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeService
    {
        ...
        void DeleteProductAttributeCombinations(IList<ProductAttributeCombination> combinations);
        ...
        /// <returns>Product attribute combination list</returns>
        IList<ProductAttributeCombination> GetProductAttributeCombinationByIds(int[] productAttributeCombinationIds);
