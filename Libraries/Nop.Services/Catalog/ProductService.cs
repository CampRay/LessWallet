    ...
    public partial class ProductService : IProductService
    {
        ...
        public virtual void AdjustInventory(Product product, int quantityToChange, string attributesXml = "", string message = "")
        {
            ...
            if (product.ManageInventoryMethod == ManageInventoryMethod.ManageStock)
            {
                ...
                //update stock quantity 修改现有库存数量
                if (product.UseMultipleWarehouses)//如果是多仓库
                {
                ...
                else
                {
                    ...
                    //simple inventory management 进行简单的存货管理
        ...
        /// <summary>
        /// Reserve the given quantity in the warehouses.预订库存数量
        /// </summary>
        /// <param name="product">Product</param>
        ...
        public virtual void ReserveInventory(Product product, int quantity)
        {
            ...
            // 1st pass: Applying reserved申请预订要购买的库存数量
            pass();
            //如果现有库存数量不足，
            if (qty > 0)
            {
        ...
        /// <summary>
        /// Unblocks the given quantity reserved items in the warehouses取消已预订的库存数量
        /// </summary>
        /// <param name="product">Product</param>
